...
import { authenticate, addUserToDB } from '@/app/lib/actions';

// TODO: This needs updated to function as an add user form. The code below was copied from login form
export default function AddUserForm() {

    //const [_, dispatch] = useFormState(addUserToDB, undefined);

    return (
        <form action={addUserToDB} className="space-y-3">
...
function AddButton() {
    return (
        <Button className="mt-8 w-full">
            Add User <ArrowRightIcon className="ml-auto h-5 w-5 text-white" />
        </Button>
    );
}
